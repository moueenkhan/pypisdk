...
result = software_management_reports_v1_controller.list_account_devices(account, start_index)
```
...
result = software_management_reports_v1_controller.list_upgrades_for_specified_status(account, upgrade_status, start_index)
```
...
result = software_management_reports_v1_controller.get_device_firmware_upgrade_history(account, device_id)
```
