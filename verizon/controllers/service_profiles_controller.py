...
class ServiceProfilesController(BaseController):
    ...
    def get_service_profile(self,
        ...
        Returns:
            ResourcesServiceProfileWithId: Response from the API. Requested
                service profile
    ...
    def create_service_profile(self,
        ...
        Returns:
            CreateServiceProfileResult: Response from the API. service profile
                ID
    ...
    def list_service_profiles(self):
        ...
        Returns:
            ListServiceProfilesResult: Response from the API. A comma
    ...
    def update_service_profile(self,
        ...
        Returns:
            UpdateServiceProfileResult: Response from the API. Update a
                service profile
    ...
    def delete_service_profile(self,
        ...
        Returns:
            DeleteServiceProfileResult: Response from the API. Delete a
                service profile
