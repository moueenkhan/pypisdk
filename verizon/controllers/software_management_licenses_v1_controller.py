...
class SoftwareManagementLicensesV1Controller(BaseController):
    ...
    def create_list_of_licenses_to_remove(self,
        ...
        Returns:
            V1ListOfLicensesToRemoveResult: Response from the API. List of
                licenses assigned
    ...
    def remove_licenses_from_devices(self,
        ...
        Returns:
            V1LicensesAssignedRemovedResult: Response from the API. List of
                licenses assigned
    ...
    def delete_list_of_licenses_to_remove(self,
        ...
        Returns:
            FotaV1SuccessResult: Response from the API. Upgrade canceled
    ...
    def list_licenses_to_remove(self,
        ...
        Returns:
            V1ListOfLicensesToRemove: Response from the API. List of
