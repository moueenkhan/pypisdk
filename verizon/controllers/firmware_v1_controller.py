...
class FirmwareV1Controller(BaseController):
    ...
    def update_firmware_upgrade_devices(self,
        ...
        Returns:
            FirmwareUpgradeChangeResult: Response from the API. Upgrade
                information
    ...
    def list_firmware_upgrade_details(self,
        ...
        Returns:
            FirmwareUpgrade: Response from the API. Upgrade information
    ...
    def schedule_firmware_upgrade(self,
        ...
        Returns:
            FirmwareUpgrade: Response from the API. Upgrade request
                confirmation
