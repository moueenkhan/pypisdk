...
class PerformanceMetricsController(BaseController):
    ...
    def query_mec_performance_metrics(self,
        ...
        Returns:
            MECPerformanceMetrics: Response from the API. The most recent data
                for different KPIs
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('401', 'Unauthorized', EdgePerformanceResultException)
            .local_error('403', 'Forbidden', EdgePerformanceResultException)
