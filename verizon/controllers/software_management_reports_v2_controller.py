...
class SoftwareManagementReportsV2Controller(BaseController):
    ...
    def list_account_devices(self,
        ...
        Returns:
            V2AccountDeviceList: Response from the API. Return array of
                devices.
    ...
    def get_campaign_history_by_status(self,
        ...
        Returns:
            V2CampaignHistory: Response from the API. Return array of campaign
                history.
    ...
    def get_campaign_device_status(self,
        ...
        Returns:
            V2CampaignDevice: Response from the API. Return array of campaign
                history.
