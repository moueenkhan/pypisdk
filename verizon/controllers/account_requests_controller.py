...
from verizon.models.request_result_with_status import RequestResultWithStatus
...
class AccountRequestsController(BaseController):
    ...
    def get_current_asynchronous_request_status(self,
        ...
        Returns:
            RequestResultWithStatus: Response from the API. The request
                status.
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RequestResultWithStatus.from_dictionary)
