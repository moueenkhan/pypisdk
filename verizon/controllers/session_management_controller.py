...
class SessionManagementController(BaseController):
    ...
    def start_connectivity_management_session(self,
        ...
        Returns:
            LogInResult: Response from the API. VZ-M2M session token
    ...
    def reset_connectivity_management_password(self,
        ...
        Returns:
            SessionResetPasswordResult: Response from the API. Returns a new,
                randomly generated password for the current username.
