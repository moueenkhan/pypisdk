...
from verizon.models.start_diagnostics_observation_result import StartDiagnosticsObservationResult
from verizon.models.stop_diagnostics_observation_result import StopDiagnosticsObservationResult
...
class DiagnosticsObservationsController(BaseController):
    ...
    def start_diagnostics_observation(self,
        ...
        Returns:
            StartDiagnosticsObservationResult: Response from the API. OK
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(StartDiagnosticsObservationResult.from_dictionary)
        ).execute()
    ...
    def stop_diagnostics_observation(self,
        ...
        Returns:
            StopDiagnosticsObservationResult: Response from the API. OK
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(StopDiagnosticsObservationResult.from_dictionary)
        ).execute()
