...
class SoftwareManagementCallbacksV3Controller(BaseController):
    ...
    def register_callback(self,
        ...
        Returns:
            FotaV3CallbackRegistrationResult: Response from the API. Return
    ...
    def list_registered_callbacks(self,
        ...
        Returns:
            FotaV3CallbackSummary: Response from the API. Return callback
                registration
    ...
    def deregister_callback(self,
        ...
        Returns:
            FotaV3SuccessResult: Response from the API. Delete request result
