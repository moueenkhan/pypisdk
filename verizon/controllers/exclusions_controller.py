...
class ExclusionsController(BaseController):
    ...
    def remove_devices_from_exclusion_list(self,
        ...
        Returns:
            DeviceLocationSuccessResult: Response from the API. Devices
    ...
    def exclude_devices(self,
        ...
        Returns:
            DeviceLocationSuccessResult: Response from the API. Success
    ...
    def list_excluded_devices(self,
        ...
        Returns:
            DevicesConsentResult: Response from the API. Consent Response
