...
class CloudConnectorSubscriptionsController(BaseController):
    ...
    def query_subscription(self,
        ...
        Returns:
            list of Subscription: Response from the API. Returns an array of
                all matching subscriptions. Each subscription includes the
    ...
    def create_subscription(self,
        ...
        Returns:
            Subscription: Response from the API. Returns full subscription
                resource definition
