...
class SoftwareManagementReportsV1Controller(BaseController):
    ...
    def list_account_devices(self,
        ...
        Returns:
            DeviceListQueryResult: Response from the API. Device list
    ...
    def list_upgrades_for_specified_status(self,
        ...
        Returns:
            UpgradeListQueryResult: Response from the API. Upgrade
                information
    ...
    def get_device_firmware_upgrade_history(self,
        ...
        Returns:
            list of DeviceUpgradeHistory: Response from the API. Device
                upgrade history
