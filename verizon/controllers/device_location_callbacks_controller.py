...
class DeviceLocationCallbacksController(BaseController):
    ...
    def list_registered_callbacks(self,
        ...
        Returns:
            list of DeviceLocationCallback: Response from the API. Callbacks
                response
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Error', DeviceLocationResultException)
        ).execute()
    ...
    def deregister_callback(self,
        ...
        Returns:
            DeviceLocationSuccessResult: Response from the API. Deregistration
                successful
    ...
    def register_callback(self,
        ...
        Args:
            account (string): account number
            body (DeviceLocationCallback): callback registration information
