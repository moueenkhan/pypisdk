...
class TargetsController(BaseController):
    ...
    def query_target(self,
        ...
        Returns:
            list of Target: Response from the API. A success response includes
    ...
    def create_target(self,
        ...
        Returns:
            Target: Response from the API. A success response includes the
                full target resource definition.
    ...
    def generateanexternal_id(self,
        ...
        Returns:
            GenerateExternalIDResult: Response from the API. Returns a new
                external ID.
