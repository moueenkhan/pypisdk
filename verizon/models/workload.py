...
class Workload(object):
    ...
    Attributes:
        ...
        revision_type (WorkloadRevisionTypeEnum): Revision type can be a
            BRANCH or TAG.
        helm_git_branch (ServiceOnboardingHelmGitBranch): helmGitBranch would
            have branchName, helmChartPath, and valuesYAMLPaths attributes.
        helm_git_tag (ServiceOnboardingHelmGitTag): helmGitTag would have
            tagName, helmChartPath, and valuesYAMLPaths attributes.
        helm_yaml_git_tag (ServiceOnboardingHelmYamlGitTag): helmYamlGitTag
            would have tagName and valuesYAMLPaths attributes.
        helm_helmrepo (ServiceOnboardingHelmHelmrepo): helmHelmrepo would have
            HelmChartName and HelmChartVersion.
        yaml_git_branch (ServiceOnboardingYamlGitBranch): yamlGitBranch would
            have branchName and valuesYAMLPaths attributes.
