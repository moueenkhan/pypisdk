...
class StopDiagnosticsObservationResult(object):

    """Implementation of the 'StopDiagnosticsObservationResult' model.
    ...
    def __init__(self,
                 ...
                 status=None,
                 created_on=None):
        """Constructor for the StopDiagnosticsObservationResult class"""
