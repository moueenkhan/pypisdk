...
class StartDiagnosticsObservationResult(object):

    """Implementation of the 'StartDiagnosticsObservationResult' model.
    ...
    def __init__(self,
                 ...
                 status=None,
                 created_on=None):
        """Constructor for the StartDiagnosticsObservationResult class"""
