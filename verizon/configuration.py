...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(
        ...
        retry_methods=['GET', 'PUT', 'GET', 'PUT'], environment=Environment.PRODUCTION, oauth_client_id='TODO: Replace',
        oauth_client_secret='TODO: Replace', oauth_token=None, oauth_scopes=None, vz_m2m_token='TODO: Replace'
    ):
    ...
    environments = {
        Environment.PRODUCTION: {
            ...
            Server.DEFAULT1: 'https://thingspace.verizon.com/api/m2m/v1',
            Server.DEFAULT2: 'https://thingspace.verizon.com/api/loc/v1',
            Server.DEFAULT3: 'https://thingspace.verizon.com/api/fota/v1',
            Server.DEFAULT4: 'https://thingspace.verizon.com/api/fota/v2',
            Server.DEFAULT5: 'https://thingspace.verizon.com/api/fota/v3',
            Server.DEFAULT6: 'https://thingspace.verizon.com/api/m2m',
            Server.AUTH_SERVER: 'https://localhost:9443/oauth2',
            Server.DEFAULT7: 'https://5gedge.verizon.com/api/mec',
            Server.DEFAULT8: 'https://thingspace.verizon.com/api/diagnostics/v1',
            Server.DEFAULT9: 'https://thingspace.verizon.com/api/cc/v1',
            Server.DEFAULT10: 'https://thingspace.verizon.com/api/hyper-precise/v1',
            Server.DEFAULT11: 'https://5gedge.verizon.com/api/mec/services'
        },
        Environment.STAGING: {
            ...
            Server.DEFAULT1: 'https://staging.thingspace.verizon.com/api/m2m/v1',
            Server.DEFAULT2: 'https://staging.thingspace.verizon.com/api/loc/v1',
            Server.DEFAULT3: 'https://staging.thingspace.verizon.com/api/fota/v1',
            Server.DEFAULT4: 'https://staging.thingspace.verizon.com/api/fota/v2',
            Server.DEFAULT5: 'https://staging.thingspace.verizon.com/api/fota/v3',
            Server.DEFAULT6: 'https://staging.thingspace.verizon.com/api/m2m',
            Server.AUTH_SERVER: 'https://localhost:9443/oauth2',
            Server.DEFAULT7: 'https://staging.5gedge.verizon.com/api/mec',
            Server.DEFAULT8: 'https://staging.thingspace.verizon.com/api/diagnostics/v1',
            Server.DEFAULT9: 'https://staging.thingspace.verizon.com/api/cc/v1',
            Server.DEFAULT10: 'https://staging.thingspace.verizon.com/api/hyper-precise/v1',
            Server.DEFAULT11: 'https://staging.5gedge.verizon.com/api/mec/services'
        }
    }
